...
latex_documents = [
    (master_doc, 'GPython.tex', 'GPython Documentation',
     'javabird25 (Protocs)', 'manual'),
]
...
man_pages = [
    (master_doc, 'gpython', 'GPython Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GPython', 'GPython Documentation',
     author, 'GPython', 'One line description of project.',
     'Miscellaneous'),
]
